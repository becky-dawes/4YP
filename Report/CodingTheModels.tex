...
\node[multiline]{\Tree[.$\bullet$ core [.\textit{letters} {file\\reader} {hierarchical\\dirichlet} {letter\\maker} {letter\\predictor} {letter\\probs} ] [.\textit{words} {file\\reader} {good\\turing} {word\\maker} {word\\predictor} {word\\probs} ] [.\textit{misc} {misc\\functions} ] ]};
\end{tikzpicture}}
