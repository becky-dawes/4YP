...
If $n$ customers are already seated giving $K_{v}$ tables being occupied, the probabilities of the next customer sitting at an occupied table or choosing a new table are given by Equations \ref{eq:CRPExisting} and \ref{eq:CRPNew} respectively \cite{wood2009hierarchical}, where $z_{v}^{n+1}$ is the table at which the customer will sit, $c_{v}^{k}$ is the number of customers sitting at the $k$\textsuperscript{th} table, $d_{v}$ is the discount parameter, $\alpha_{v}$ is the concentration parameter and the subscript $v\in V$ denotes a vertex in the graphical model. 
...
\noindent The final tree for ``the" is as in Figure \ref{fig:theCodeSuffixTree}.
...
\end{lstlisting}
\doublespacing
\caption{Suffix Tree for ``the"}
\label{fig:theCodeSuffixTree}
\end{figure}
...
\begin{tikzpicture}[node distance = 4cm, auto,>=triangle 45]
 ...
 \node [block, left of=match_range_check,node distance=5.4cm] (branch) {Branch node into two sections and instantiate table for first symbol of suffix};
...
Figure \ref{fig:buildTreeFlowchart} details the tree building procedure. The cycle continues until the longest suffix has been constructed. A main \lstinline!build_tree! function was written with several auxiliary functions supporting it. 
...
[1 1]}},
 ...
 \end{lstlisting}
\doublespacing
\caption{Suffix Tree for ``mississippi"}
\label{fig:mississippiCodeSuffixTree}
\end{figure}
...
\begin{figure}
\Tree [.$\bullet$ [.i \$ [.p [.p i\$ ] ] [.s [.s [.i [.p [.p i\$ ] ] [.s [.s [.i [.p [.p i\$ ] ] ] ] ] ] ] ] ] [.p [.p i\$ ] i\$ ] [.s [.i [.p [.p i\$ ] ] [.s [.s [.i [.p [.p i\$ ] ] ] ] ] ] [.s [.i [.p [.p i\$ ] ] [.s [.s [.i [.p [.p i\$ ] ] ] ] ] ] ] ] [.m [.i [.s [.s [.i [.s [.s [.i [.p [.p i\$ ] ] ] ] ] ] ] ] ] ] ]
\caption{Suffix Trie for ``mississippi"}
