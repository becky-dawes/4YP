\chapter{Hierarchical Dirichlet Model}
...
Level 1 inference involves inferring a distribution for $Q$. For this, we assume that we know $\boldsymbol{m}$ and $\alpha$. Equation \ref{eq:HD-Q|D-alpham-H} then gives the posterior for $Q$. (\textit{explain}) \todo[inline]{Explain posterior for Q}
